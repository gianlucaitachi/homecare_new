...
class _ScanViewState extends State<ScanView> with WidgetsBindingObserver {
  ...
  Future<void> _onDetect(BarcodeCapture capture) async {
    ...
    final payload = qrService.parse(value);
    if (payload == null) {
      _showError('Unsupported QR code. Please try again.');
  ...
  Future<void> _completeTask(QrPayload payload) async {
    ...
    try {
      ...
      final task = await repository.completeByQr(
      ...
      final message = taskTitle is String && taskTitle.isNotEmpty
